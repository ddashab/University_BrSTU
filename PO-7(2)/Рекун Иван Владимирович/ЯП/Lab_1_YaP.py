...
def task4_2():
	my_string = 'ФИО; Возраст; Категория; Иванов; Иван; Иванович; 23 года; Студент 3 курса; Петро; Семён; Игоревич; 22 года; Студент 2 курса'
	spisok = pd.DataFrame({
		"ФИО                 ": ['Иванов Иван Иванович', 'Петро Семён Игоревич'],
